...
import com.ajith.userService.config.interceptor.RestTemplateInterceptor;
...
//    }
    ...
    public RestTemplate restTemplate() {
        ...
        interceptor.add(new RestTemplateInterceptor(manager(clientRegistrationRepository,
    ...
    // creating the bean of oauth2AuthrizedClientManager
